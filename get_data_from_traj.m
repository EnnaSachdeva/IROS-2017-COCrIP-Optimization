function  [contact_points,centres,angles,init,points ]  = get_data_from_traj(data,initialization,in_curv_points,i,steps )
...
theta1_temp=initialization(1);
theta2_temp=initialization(2);

theta1_2_temp=initialization(3);
theta1_3_temp=initialization(4);

theta2_2_temp=initialization(5);
theta2_3_temp=initialization(6);

theta3_2_temp=initialization(7);
theta3_3_temp=initialization(8);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    x1_1=in_curv_points(1); %%%% sub module 1 x point of contact with pipe
    y1_1=in_curv_points(2); %%%% sub module 1 y point of contact with pipe
...
%     theta1_2=pi/2-theta1_2;
    ...
    thetaMod1=[theta1_1 ,theta1_2 ,theta1_3]; %% angle of submodules w.r.t horizontal
    pointsMod1=[x1_1,y1_1,x1_2,y1_2,x1_3,y1_3;];
...
%  x0=0; with 0 as the initialization, it converges to any random point
   ...
   thetalink1=[theta1-pi];
%      thetalink1=[thetalink1;theta1];
%   
  ...
  theta2_1=theta+alpha;%%%% sub module 1 angle w.r.t horizontal
   ...
   thetaMod2=[(theta2_1) ,(theta2_2) ,(theta2_3)];
   pointsMod2=[x2_1,y2_1,x2_2,y2_2,x2_3,y2_3;];
...
%     
   ...
   %%%%  For submodule 3_2
    ...
    thetaMod3=[(theta3_1) ,(theta3_2) ,(theta3_3)];
    pointsMod3=[x3_1,y3_1,x3_2,y3_2,x3_3,y3_3;];   
...
%       
   ...
   angles=[thetaMod1,thetalink1,thetaMod2,thetalink2,thetaMod3];
   init=[theta1,theta2,theta1_2,theta1_3,theta2_2,theta2_3,theta3_2,theta3_3];
   
%    h11= plot(link1_x,link1_y,link2_x,link2_y,...
%            x1_1, y1_1,'b*',x1_2, y1_2,'r*',x1_3, y1_3,'c*', x1, y1,'y--o',x21, y21,'g--o',...
%            x2_1,y2_1,'b*',x2_2,y2_2,'r*',x2_3,y2_3,'c*',x22,y22,'g--o',x31,y31,'b--o',...
%            x3_1,y3_1,'b*',x3_2, y3_2,'r*',x3_3, y3_3,'c*'); 
%    
  points=[link1_x,link1_y,link2_x,link2_y,...
           x1_1, y1_1,x1_2, y1_2,x1_3, y1_3, x1, y1,x21, y21,...
           x2_1,y2_1,x2_2,y2_2,x2_3,y2_3,x22,y22,x31,y31,...
